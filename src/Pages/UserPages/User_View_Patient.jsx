...
export default function User_View_Patient() {
    ...
    <div className="w-full overflow-y-auto">
      ...
      <div className="flex flex-col gap-5 py-5 lg:px-20 md:px-10 px-3">
          ...
          <div className="flex justify-end gap-5 fade-in-right">
            <Link to="/user_records" className="flex">
              <Button name="Back"/>
            </Link>
            <Link to="/user_edit_patient" className="flex">
              <Button name="Edit"/>
            </Link>
          </div>
          <div className="flex flex-col lg:flex-row gap-5 md:justify-evenly lg:p-10 p-5 shadow-lg rounded-2xl fade-in-up">
              <div className="flex flex-col md:gap-5 gap-2 items-center">
                <img src='/Default.jpg' alt="Profile Pic" className="md:w-60 w-50 shadow-lg object-cover aspect-square"></img>
                <div className="flex flex-col md:flex-row w-full gap-2 items-center">
                  ...
                  <input type="text" readOnly id="image" name="image" className="lg:px-5 lg:py-3 px-3 py-2 md:w-96 w-full bg-slate-200 rounded-lg cursor-pointer"/>
                </div>
                <div className="flex flex-col md:flex-row w-full gap-2 items-center">
                  <label className="text-lg font-medium md:w-42 w-full" htmlFor="name">Birth Reference No.</label>
                  <input type="text" readOnly className="lg:px-5 lg:py-3 px-3 py-2 md:w-96 w-full bg-slate-200 rounded-lg"/>
                </div>
                <div className="flex flex-col md:flex-row w-full gap-2 items-center">
              ...
              <div className="flex flex-col md:gap-5 gap-2 items-center">
                ...
                <div className="flex flex-col md:flex-row w-full md:gap-8 gap-2 items-center">
                  <div className="flex flex-col md:flex-row w-full md:gap-5 gap-2 items-center">
                    ...
                    <input type="text" readOnly className="px-3 py-2 md:w-40 w-full bg-slate-200 rounded-lg"/>
                  </div>
                ...
                <div className="flex flex-col md:flex-row w-full md:gap-8 gap-2 items-center">
                    <div className="flex flex-col md:flex-row w-full md:gap-5 gap-2 items-center">
                      ...
                      <div className="flex gap-3 items-center">
                        <input type="radio" disabled value="Male" className="cursor-pointer"/>
                        <label className="text-lg font-medium" htmlFor="name">Male</label>
                        <input type="radio" disabled value="Female" className="cursor-pointer"/>
