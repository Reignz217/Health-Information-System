...
export default function User_Dashboard() {
  ...
  const card = [
    {Name: 'Appointment', Icon: <Folder size={40}/>, Count: 10},
    {Name: 'Recent Login', Icon: <User size={40}/>, Count: 1},
    {Name: 'Patient', Icon: <UserPlus size={40}/>, Count: 10},
  ]
  ...
  return (
    <div className="w-full overflow-y-auto">
      <section className='my-5'>
        ...
        <div className='grid lg:grid-cols-3 grid-cols-2 justify-center gap-10 p-5'>
          {card.map((item,index) =>
